...
namespace ClubCompFS
{
    ...
    internal sealed class Module1
    {
        ...
        public static void Sort_J_GOE(int NoJ)
        {
            ...
            {
                ProjectData.SetProjectError(ex);
                int num7 = (int)Interaction.MsgBox((object)("Sort_J_GOE - " + Information.Err().Description), MsgBoxStyle.SystemModal, (object)"Susanne SW");
            }
        }
        ...
        public static void Sort_J_PC(int NoJ)
        {
            ...
            {
                ProjectData.SetProjectError(ex);
                int num7 = (int)Interaction.MsgBox((object)("Sort_J_PC - " + Information.Err().Description), MsgBoxStyle.SystemModal, (object)"Susanne SW");
            }
        }
        ...
        public static void SortListStartNo(int NoOfSkater)
        {
            ...
            {
                ProjectData.SetProjectError(ex);
                int num6 = (int)Interaction.MsgBox((object)("SortListStartNo - " + Information.Err().Description), MsgBoxStyle.SystemModal, (object)"Susanne SW");
            }
        }
        ...
        public static bool CreateHTMFile(int StNo)
        {
            ...
            {
                ProjectData.SetProjectError(ex);
                int num4 = (int)Interaction.MsgBox((object)("CreateHTMFile - " + Information.Err().Description), MsgBoxStyle.SystemModal, (object)"Susanne SW");
                return htmFile;
            }
        }
        ...
        public static bool CreateHTMFileSpeaker(int StNo)
        {
            ...
            {
                ProjectData.SetProjectError(ex);
                int num3 = (int)Interaction.MsgBox((object)("CreateHTMFileSpeaker - " + Information.Err().Description), MsgBoxStyle.SystemModal, (object)"Susanne SW");
                return htmFileSpeaker;
            }
        }
