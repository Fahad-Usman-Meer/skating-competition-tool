            ...
            try
            {
                ...
                switch (Module1.JudgeSel)
                {
                    case 0:
                        ...
                        form1.txtNonJudgingReferee.Text = "Referee and Judge no. " + Microsoft.VisualBasic.Strings.Trim(Conversions.ToString(index1)) + " for Scores";
                ...
                do
                {
                    ...
                    {
                        form1.Controls[key3].Text = "Judge " + Microsoft.VisualBasic.Strings.Trim(Conversions.ToString(index2));
                        form1.Controls[key3].Visible = true;
                    }
                    else if (index2 > Module1.NoJ_GOE & index2 <= checked(Module1.NoJ_GOE + Module1.NoTrj))
                    {
                        form1.Controls[key3].Text = "Tr. Judge " + Microsoft.VisualBasic.Strings.Trim(Conversions.ToString(index2));
                        form1.Controls[key3].Visible = true;
                    }
                    else if (index2 == checked(Module1.JudgeSel * 7))
                    {
                        form1.Controls[key3].Text = "Non J. Ref. " + Microsoft.VisualBasic.Strings.Trim(Conversions.ToString(index2));
                        form1.Controls[key3].Visible = true;
                    }
                    else
            ...
            try
            {
                ...
                if (Module1.TNop > 0)
                {
                    ...
                    if (MyProject.Computer.FileSystem.DirectoryExists(Module1.PathResultsFile))
                    {
                        ...
                        {
                            num3 = 70;
                            if (MyProject.Forms.Form1.completed10)
                            {
                                num3 = 71;
