...
namespace ClubCompFS
{
  ...
  public class Form6 : Form
  {
    ...
    internal virtual ToolStripMenuItem SHOWRESULTSToolStripMenuItem
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._SHOWRESULTSToolStripMenuItem = value;
    }
...
label_33:
      ...
      int msg)
    {
          ...
          while (index2 <= num10)
          {
            ...
            switch (index2)
            {
              case 0:
                ...
                XRect xrect3 = new XRect((double) checked (num9 + 1), (double) y5, (double) width2, (double) height2);
      ...
      if (num1 == 2)
      {
        int num13 = (int) Interaction.MsgBox((object) ("Form6, ExportDataToPDFTable1 - \r\n" + Information.Err().Description), MsgBoxStyle.Critical, (object) "Susanne SW");
      }
label_63:
      if (num2 == 0)
        return;
