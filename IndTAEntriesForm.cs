...
namespace ClubCompFS
{
    ...
    public class IndTAEntriesForm : Form
    {
        ...
        public void Sort_IndTA_Klass_Club_Surname(int no)
        {
            ...
            if (num1 == 2)
            {
                int num4 = (int)Interaction.MsgBox((object)("IndTAEntriesForm.Sort_IndTA_Klass_Club_Surname - " + Information.Err().Description), MsgBoxStyle.SystemModal, (object)"Susanne SW");
            }
            label_11:
            if (num2 == 0)
                return;
        ...
        public void Sort_IndTA_Surname(int start, int stopp)
        {
            ...
            if (num1 == 2)
            {
                int num7 = (int)Interaction.MsgBox((object)("IndTAEntriesForm.Sort_IndTA_Surname - " + Information.Err().Description), MsgBoxStyle.SystemModal, (object)"Susanne SW");
            }
            label_14:
            if (num2 == 0)
                return;
