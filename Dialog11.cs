...
namespace ClubCompFS
{
  ...
  public class Dialog11 : Form
  {
    ...
    {
      get => this._DedLabel4;
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._DedLabel4 = value;
    }

    internal virtual TextBox DedLabel5
    {
      get => this._DedLabel5;
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._DedLabel5 = value;
    }

    internal virtual TextBox DedLabel6
    {
      get => this._DedLabel6;
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._DedLabel6 = value;
    }

    internal virtual TextBox DedLabel7
    {
      get => this._DedLabel7;
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._DedLabel7 = value;
    }

    internal virtual TextBox DedLabel8
    {
      get => this._DedLabel8;
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._DedLabel8 = value;
    }
    ...
    {
      get => this._DedLabel9;
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._DedLabel9 = value;
    }
    ...
    internal virtual TextBox DedLabel10
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._DedLabel10 = value;
    }
...
label_26:
    ...
    private void m4_Click(object sender, EventArgs e)
    {
      ...
      try
      {
        ...
        if (Strings.Len(this.Ded_4.Text) <= 0)
        {
          if (num3 <= 0)
            return;
          this.Ded_4.Text = Conversions.ToString(checked (num3 - 1));
        }
        else
        {
          int integer = Conversions.ToInteger(this.Ded_4.Text);
          if (integer <= 0)
            return;
          this.Ded_4.Text = Conversions.ToString(checked (integer - 1));
        }
      }
      catch (Exception ex) when (ex != null & num1 != 0 & num2 == 0)
      {
    ...
    private void p4_Click(object sender, EventArgs e)
    {
      ...
      try
      {
        ...
        num1 = 1;
        if (Strings.Len(this.Ded_4.Text) > 0)
          num3 = Conversions.ToInteger(this.Ded_4.Text);
        if (num3 >= 9)
        {
          int num4 = (int) Interaction.MsgBox((object) ("Max no. of Deduction = " + Conversions.ToString(9) + "!"), MsgBoxStyle.SystemModal, (object) "Susanne SW");
        }
        else
          this.Ded_4.Text = Conversions.ToString(checked (num3 + 1));
      }
    ...
    private void m5_Click(object sender, EventArgs e)
    {
      ...
      try
      {
        ...
        if (Strings.Len(this.Ded_5.Text) > 0)
          num3 = Conversions.ToInteger(this.Ded_5.Text);
        if (num3 <= 0)
          return;
        this.Ded_5.Text = Conversions.ToString(checked (num3 - 1));
      }
      catch (Exception ex) when (ex != null & num1 != 0 & num2 == 0)
      {
        ProjectData.SetProjectError(ex);
    ...
    private void p5_Click(object sender, EventArgs e)
    {
      ...
      try
      {
        ...
        if (num3 >= 19)
        {
          int num4 = (int) Interaction.MsgBox((object) ("Max no. of Deduction = " + Conversions.ToString(19) + "!"), MsgBoxStyle.SystemModal, (object) "Susanne SW");
        }
        else
          this.Ded_5.Text = Conversions.ToString(checked (num3 + 1));
      }
    ...
    private void m6_Click(object sender, EventArgs e)
    {
      ...
      try
      {
        ...
        if (Strings.Len(this.Ded_6.Text) > 0)
          num3 = Conversions.ToInteger(this.Ded_6.Text);
        if (num3 <= 0)
          return;
        this.Ded_6.Text = Conversions.ToString(checked (num3 - 1));
      }
      catch (Exception ex) when (ex != null & num1 != 0 & num2 == 0)
      {
        ProjectData.SetProjectError(ex);
    ...
    private void m7_Click(object sender, EventArgs e)
    {
      ...
      try
      {
        ...
        if (Strings.Len(this.Ded_7.Text) > 0)
          num3 = Conversions.ToInteger(this.Ded_7.Text);
        if (num3 <= 0)
          return;
        this.Ded_7.Text = Conversions.ToString(checked (num3 - 1));
      }
      catch (Exception ex) when (ex != null & num1 != 0 & num2 == 0)
      {
        ProjectData.SetProjectError(ex);
    ...
    private void m8_Click(object sender, EventArgs e)
    {
      ...
      try
      {
        ...
        if (Strings.Len(this.Ded_8.Text) > 0)
          num3 = Conversions.ToInteger(this.Ded_8.Text);
        if (num3 <= 0)
          return;
        this.Ded_8.Text = Conversions.ToString(checked (num3 - 1));
      }
      catch (Exception ex) when (ex != null & num1 != 0 & num2 == 0)
      {
        ProjectData.SetProjectError(ex);
    ...
    private void m9_Click(object sender, EventArgs e)
    {
      ...
      try
      {
        ...
        if (Strings.Len(this.Ded_9.Text) > 0)
          num3 = Conversions.ToInteger(this.Ded_9.Text);
        if (num3 <= 0)
          return;
        this.Ded_9.Text = Conversions.ToString(checked (num3 - 1));
      }
      catch (Exception ex) when (ex != null & num1 != 0 & num2 == 0)
      {
        ProjectData.SetProjectError(ex);
    ...
    private void m10_Click(object sender, EventArgs e)
    {
      ...
      try
      {
        ...
        if (Strings.Len(this.Ded_10.Text) > 0)
          num3 = Conversions.ToInteger(this.Ded_10.Text);
        if (num3 <= 0)
          return;
        this.Ded_10.Text = Conversions.ToString(checked (num3 - 1));
      }
      catch (Exception ex) when (ex != null & num1 != 0 & num2 == 0)
      {
        ProjectData.SetProjectError(ex);
