...
namespace ClubCompFS
{
  ...
  public class Form2 : Form
  {
    ...
    internal virtual ToolStripMenuItem IndTAToolStripMenuItem
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._IndTAToolStripMenuItem = value;
    }
    ...
    internal virtual ToolStripMenuItem GenerateStartNoToolStripMenuItem
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._GenerateStartNoToolStripMenuItem = value;
    }
    ...
    internal virtual ToolStripMenuItem ToolStripMenuItemFile
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._ToolStripMenuItemFile = value;
    }

    internal virtual TextBox Mode
    {
      get => this._Mode;
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._Mode = value;
    }
    ...
    {
      get => this._Column5;
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._Column5 = value;
    }

    internal virtual DataGridViewTextBoxColumn Column6
    {
      get => this._Column6;
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._Column6 = value;
    }

    internal virtual DataGridViewTextBoxColumn Column7
    {
      get => this._Column7;
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._Column7 = value;
    }

    internal virtual DataGridViewTextBoxColumn Column8
    {
      get => this._Column8;
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._Column8 = value;
    }
    ...
    internal virtual ToolStripMenuItem EDITSKATERToolStripMenuItem
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._EDITSKATERToolStripMenuItem = value;
    }
    ...
    internal virtual ToolStripMenuItem WARMUPToolStripMenuItem
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._WARMUPToolStripMenuItem = value;
    }
    ...
    {
      get => this._txtMP;
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._txtMP = value;
    }
        ...
        else
        {
          ...
          while (index1 <= num5)
          {
            ...
            if (Operators.CompareString(segment, "Seg1", false) != 0)
            {
              ...
              {
                dataGridView1.Rows[checked (index1 - 1)].Cells[0].Value = Module1.Vek[index1].DNS_Seg1 > 0 ? (object) "" : (object) Module1.Vek[index1].Startno_Seg2;
                dataGridView1.Rows[checked (index1 - 1)].Cells[6].Value = Module1.Vek[index1].Finished_Seg2 == 1 ? (object) "Yes" : (object) "No";
                ...
                else
                {
                  ...
                  dataGridView1.Rows[checked (index1 - 1)].Cells[7].Style.BackColor = (double) Module1.Vek[index1].WarmUp_Seg2 / 2.0 == Conversion.Int((double) Module1.Vek[index1].WarmUp_Seg2 / 2.0) ? Color.LightCyan : Color.LightPink;
                  dataGridView1.Rows[checked (index1 - 1)].Cells[5].Style.BackColor = Color.Yellow;
                }
              }
            }
            else
            {
              ...
              dataGridView1.Rows[checked (index1 - 1)].Cells[6].Value = Module1.Vek[index1].Finished_Seg1 == 1 ? (object) "Yes" : (object) "No";
              ...
              else
              {
                ...
                dataGridView1.Rows[checked (index1 - 1)].Cells[7].Style.BackColor = (double) Module1.Vek[index1].WarmUp_Seg1 / 2.0 == Conversion.Int((double) Module1.Vek[index1].WarmUp_Seg1 / 2.0) ? Color.LightCyan : Color.LightPink;
                dataGridView1.Rows[checked (index1 - 1)].Cells[4].Style.BackColor = Color.Yellow;
              }
            }
