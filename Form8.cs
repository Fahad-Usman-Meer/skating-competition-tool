...
namespace ClubCompFS
{
  ...
  public class Form8 : Form
  {
    ...
    internal virtual ToolStripMenuItem PRINTToolStripMenuItem
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._PRINTToolStripMenuItem = value;
    }
    ...
    {
      get => this._txtJno;
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._txtJno = value;
    }

    internal virtual TextBox txtTCTSName
    {
      get => this._txtTCTSName;
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._txtTCTSName = value;
    }
              ...
              case 7:
                switch (index)
                {
                  ...
                  case 2:
                    ...
                    e.Graphics.DrawRectangle(Pens.Black, layoutRectangle.Left, layoutRectangle.Top, layoutRectangle.Width, layoutRectangle.Height);
                    e.Graphics.DrawString("\r\nImpostazione di base", font2, Brushes.Black, layoutRectangle, format2);
                    break;
                  case 3:
                    int num24 = 180;
