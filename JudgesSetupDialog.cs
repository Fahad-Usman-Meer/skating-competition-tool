...
namespace ClubCompFS
{
    ...
    public class JudgesSetupDialog : Form
    {
        ...
        internal virtual TextBox txtNonJudgingRefree
        {
            ...
            [MethodImpl(MethodImplOptions.Synchronized)]
            set => this._txtNonJudgingRefree = value;
        }
