...
namespace ClubCompFS
{
  ...
  public class Dialog3 : Form
  {
    ...
    {
      get => this._txtwarmup;
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._txtwarmup = value;
    }
    ...
    {
      get => this._lblPort;
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._lblPort = value;
    }
    ...
    {
      get => this._txtJD;
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._txtJD = value;
    }
    ...
    {
      get => this._txtAdjust;
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._txtAdjust = value;
    }
