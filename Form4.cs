...
namespace ClubCompFS
{
  ...
  public class Form4 : Form
  {
    ...
    internal virtual MenuStrip MenuStrip2
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._MenuStrip2 = value;
    }

    internal virtual TextBox txtIndex
    {
      get => this._txtIndex;
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._txtIndex = value;
    }
    ...
    internal virtual DataGridView DataGridView2
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._DataGridView2 = value;
    }
    ...
    internal virtual PrintPreviewDialog PrintPreviewDialog2
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._PrintPreviewDialog2 = value;
    }
    ...
    {
      get => this._Column9;
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._Column9 = value;
    }

    internal virtual DataGridViewTextBoxColumn Column10
    {
      get => this._Column10;
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._Column10 = value;
    }

    internal virtual DataGridViewTextBoxColumn Column11
    {
      get => this._Column11;
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._Column11 = value;
    }

    internal virtual DataGridViewTextBoxColumn Column12
    {
      get => this._Column12;
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._Column12 = value;
    }

    internal virtual DataGridViewTextBoxColumn Column13
    {
      get => this._Column13;
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._Column13 = value;
    }

    internal virtual DataGridViewTextBoxColumn Column14
    {
      get => this._Column14;
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._Column14 = value;
    }

    internal virtual TextBox txtPrint
    {
      get => this._txtPrint;
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._txtPrint = value;
    }

    internal virtual DataGridViewTextBoxColumn Column15
    {
      get => this._Column15;
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._Column15 = value;
    }

    internal virtual DataGridViewTextBoxColumn Column16
    {
      get => this._Column16;
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._Column16 = value;
    }
    ...
    internal virtual TextBox txtNoOfCopies
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._txtNoOfCopies = value;
    }

    internal virtual PrintDialog PrintDialog1
    {
      get => this._PrintDialog1;
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._PrintDialog1 = value;
    }

    internal virtual BackgroundWorker BackgroundWorker1
    {
      get => this._BackgroundWorker1;
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._BackgroundWorker1 = value;
    }
...
label_18:
    ...
    public void ExportDataToPDFTable1(int norow, int nocol, string txt, string pathfile, int msg)
    {
      ...
      try
      {
        ...
        int width1 = checked ((int) Math.Round(unchecked (page.Width.Point - (double) x1 - (double) num4)));
        ...
        do
        {
          ...
          {
            checked { ++num7; }
            int y1 = num7 != 1 ? checked (num8 + 4 * height) : num3;
            int num9 = y1;
            xgraphics1.DrawLine(XPens.Gray, checked (x1 - 1), checked (y1 - 1), checked (x1 + width1 + 1), checked (y1 - 1));
            height = checked ((int) Math.Round(font1.GetHeight()));
            xgraphics1.DrawString("JUDGES DETAILS", font1, (XBrush) XBrushes.Black, new XRect((double) x1, (double) y1, (double) width1, (double) height), XStringFormats.TopLeft);
            ...
            XRect xrect1 = new XRect((double) x1, (double) y2, (double) width1, (double) height);
            ...
            xgraphics1.DrawString("CATEGORY: " + Module1.Category.Name + Module1.SubCat() + ", " + Module1.GetSegTxt(Module1.Segment), font1, (XBrush) XBrushes.Black, new XRect((double) x1, (double) y3, (double) width1, (double) height), XStringFormats.TopLeft);
            int num10 = 0;
            do
            {
              checked { ++num10; }
              if (num10 > 3)
              {
                ...
                do
                {
                  ...
                  {
                    XFont xfont5 = font1;
                    if (integer1 == 1 | integer1 == 0 & num10 == 4 | integer1 == 0 & num10 == 8 & (checked (index2 - 7) < Module1.NoJ_GOE | index2 == 14))
                    {
                      switch (index2)
                      {
                        case 1:
                        ...
                        case 14:
                          ...
                          XRect xrect2 = new XRect((double) x2, (double) y3, (double) width2, (double) height);
                        ...
                        case 2:
                          ...
                          XRect xrect3 = new XRect((double) x2, (double) y3, (double) width2, (double) height);
                    ...
                    if (integer1 == 1)
                    {
                      switch (index2)
                      {
                        ...
                        case 14:
                          ...
                          XRect xrect4 = new XRect((double) x2, (double) y3, (double) width2, (double) height);
                        ...
                        case 2:
                          ...
                          XRect xrect5 = new XRect((double) x2, (double) y3, (double) width2, (double) height);
                    ...
                    else if (num10 < 8)
                    {
                      switch (index2)
                      {
                        ...
                        case 14:
                          ...
                          XRect xrect6 = new XRect((double) x2, (double) y3, (double) width2, (double) height);
                        ...
                        case 2:
                          ...
                          XRect xrect7 = new XRect((double) x2, (double) y3, (double) width2, (double) height);
                    ...
                    else if (checked (index2 - 7) < Module1.NoJ_GOE | index2 == 14)
                    {
                      switch (index2)
                      {
                        ...
                        case 14:
                          ...
                          XRect xrect8 = new XRect((double) x2, (double) y3, (double) width2, (double) height);
                        ...
                        case 2:
                          ...
                          XRect xrect9 = new XRect((double) x2, (double) y3, (double) width2, (double) height);
            ...
            do
            {
              ...
              switch (index3)
              {
                case 1:
                  ...
                  XRect xrect10 = new XRect((double) x1 + (double) numArray[1] * (double) width1 / 100.0, (double) y3, (double) checked (x1 + width1), (double) height);
                ...
                case 2:
                  ...
                  XRect xrect11 = new XRect((double) x1 + (double) numArray[1] * (double) width1 / 100.0, (double) y3, (double) checked (x1 + width1), (double) height);
            ...
            num8 = checked (y3 + height);
            xgraphics1.DrawLine(XPens.Gray, checked (x1 - 1), checked (num9 - 1), checked (x1 - 1), checked (num8 + 1));
            xgraphics1.DrawLine(XPens.Gray, checked (x1 + width1 + 1), checked (num9 - 1), checked (x1 + width1 + 1), checked (num8 + 1));
            xgraphics1.DrawLine(XPens.Gray, checked (x1 - 1), checked (num8 + 1), checked (x1 + width1 + 1), checked (num8 + 1));
          }
          while (!(num7 == 2 | index1 >= norow | (double) integer2 != Conversions.ToDouble(Module1.F4arr[checked (index1 + 1), 0])));
          integer2 = Conversions.ToInteger(Module1.F4arr[index1, 0]);
          if (index1 != norow)
