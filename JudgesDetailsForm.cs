          ...
          10f
                ...
                do
                {
                    ...
                    do
                    {
                        ...
                        xgraphics1.DrawString("CATEGORY: " + Program.Category.Name + Program.SubCat() + ", " + Program.GetSegTxt(Program.Segment), font1, (XBrush)XBrushes.Black, new XRect((double)x1, (double)y3, (double)width1, (double)height), XStringFormats.TopLeft);
                        int num10 = 0;
                        do
                        {
                            checked { ++num10; }
                            if (num10 > 3)
                            {
                                ...
                                do
                                {
                                    ...
                                    {
                                        XFont xfont5 = font1;
                                        if (integer1 == 1 | integer1 == 0 & num10 == 4 | integer1 == 0 & num10 == 8 & (checked(index2 - 7) < Program.NoJ_GOE | index2 == 14))
                                        {
                                            switch (index2)
                                            {
                                                case 1:
                        ...
                        //XRect xrect12 = new XRect((double)x1, (double)num6 + 5.0, (double)checked(x1 + width1), (double)num6 + 7.0);
                        ...
                        //XRect xrect13 = new XRect((double)x1, (double)num6 + 13.0, (double)checked(x1 + width1), (double)num6 + 15.0);
                        ...
                        int num19 = checked(y3 + height);
                    }
                    while (!(num7 == 2 | index1 >= norow | (double)integer2 != Conversions.ToDouble(Program.F4arr[checked(index1 + 1), 0])));
