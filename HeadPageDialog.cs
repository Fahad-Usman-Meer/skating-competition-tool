...
namespace ClubCompFS
{
    ...
    public class HeadPageDialog : Form
    {
        ...
        [AccessedThroughProperty("txtPresentation1")]
        private TextBox _txtPresentation1;
        ...
        [AccessedThroughProperty("txtPresentation2")]
        private TextBox _txtPresentation2;
        ...
        private void InitializeComponent()
        {
            ...
            this.txtPresentation2 = new TextBox();
        ...
        (ToolStripItem) this.HeadPageToolStripMenuItem
            ...
            this.Label10.Text = "Presentation";// "Performance/Execution"; // "Performance";
            ...
            this.txtPresentation1.Name = "txtPresentation1";
            ...
            this.txtPresentation2.Font = new Font("Microsoft Sans Serif", 8.25f, FontStyle.Bold, GraphicsUnit.Point, (byte)0);
            ...
            this.lbl25.Text = "Presentation";// "Performance/Execution";
            ...
            this.Controls.Add((Control)this.txtPresentation2);
        ...
        {
            get => this._txtPresentation1;
            [MethodImpl(MethodImplOptions.Synchronized)]
            set => this._txtPresentation1 = value;
        }
        ...
        internal virtual TextBox txtPresentation2
        {
            get => this._txtPresentation2;
            [MethodImpl(MethodImplOptions.Synchronized)]
            set => this._txtPresentation2 = value;
        }
        ...
        public void CreateHeadPage()
        {
            ...
            if (Operators.CompareString(Program.OpenDB[Program.PcIndex].Segment_1, "S", false) == 0 | Operators.CompareString(Program.OpenDB[Program.PcIndex].Segment_1, "F", false) == 0)
            {
                ...
                dialog8.txtPresentation1.Text = Conversions.ToString(Program.OpenDB[Program.PcIndex].PCFactorsSeg1[2]);
            ...
            if (Operators.CompareString(Program.GetSeg(), "0F", false) == 0 | Operators.CompareString(Program.GetSeg(), "0S", false) == 0)
            {
                ...
                dialog8.txtPresentation1.Text = Conversions.ToString(Program.OpenDB[Program.PcIndex].PCFactorsSeg2[2]);
                ...
                dialog8.lblOpenDB.Top = checked(dialog8.txtPresentation1.Top + 29);
                dialog8.lblOpenDBCreation.Top = checked(dialog8.lblOpenDB.Top + 20);
                dialog8.lblElementDB.Top = checked(dialog8.lblOpenDB.Top + 50);
                dialog8.lblElementDBCreation.Top = checked(dialog8.lblElementDB.Top + 20);
            }
            if (Operators.CompareString(Program.GetSeg(), "SF", false) == 0 | Operators.CompareString(Program.GetSeg(), "FF", false) == 0 | Operators.CompareString(Program.GetSeg(), "SS", false) == 0)
            {
                ...
                dialog8.txtPresentation2.Visible = true;
                ...
                dialog8.txtPresentation2.Text = Conversions.ToString(Program.OpenDB[Program.PcIndex].PCFactorsSeg2[2]);
                ...
                dialog8.lblOpenDB.Top = checked(dialog8.txtPresentation2.Top + 29);
                dialog8.lblOpenDBCreation.Top = checked(dialog8.lblOpenDB.Top + 20);
                dialog8.lblElementDB.Top = checked(dialog8.lblOpenDB.Top + 50);
                dialog8.lblElementDBCreation.Top = checked(dialog8.lblElementDB.Top + 20);
            }
        ...
        private void PrintDocument1_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            try
            {
                ...
                if (Operators.CompareString(Program.GetSeg(), "F0", false) == 0)
                {
                    layoutRectangle = new RectangleF(x2, y3, (float)(200.0 * num3), height3);
                    e.Graphics.DrawString("DATE:", font2, Brushes.Black, layoutRectangle, format);
                    float x11 = x2 + (float)(200.0 * num3);
                    layoutRectangle = new RectangleF(x11, y3, (float)(200.0 * num3), height3);
                    e.Graphics.DrawString(Program.FormShortDate(Program.Datum.Seg1), font3, Brushes.Black, layoutRectangle, format);
                    layoutRectangle = new RectangleF(x11 + (float)(200.0 * num3), y3, (float)(200.0 * num3), height3);
                ...
                if (Operators.CompareString(Program.GetSeg(), "SF", false) == 0)
                {
                    ...
                    //e.Graphics.DrawString(Conversions.ToString(Program.OpenDB[Program.PcIndex].PCFactorsSeg1[4]), font3, Brushes.Black, layoutRectangle, //format);
                    float y37 = (float)((double)y35 + (double)height3 + ((double)height3 + 10.0));
                ...
                if (Operators.CompareString(Program.GetSeg(), "FF", false) == 0)
                {
                    ...
                    //e.Graphics.DrawString(Conversions.ToString(Program.OpenDB[Program.PcIndex].PCFactorsSeg1[4]), font3, Brushes.Black, layoutRectangle, format);
                    float y51 = (float)((double)y49 + (double)height3 + ((double)height3 + 10.0));
                ...
                if (Operators.CompareString(Program.GetSeg(), "SS", false) == 0)
                {
                    ...
                    //e.Graphics.DrawString(Conversions.ToString(Program.OpenDB[Program.PcIndex].PCFactorsSeg1[4]), font3, Brushes.Black, layoutRectangle, format);
                    float y65 = (float)((double)y63 + (double)height3 + ((double)height3 + 10.0));
        ...
        {
            this.PrintPreviewDialog1.TopMost = false;
        ...
        public void CreateHP_PDFfile(int msg)
        {
            ...
            if (Operators.CompareString(seg, "S0", false) == 0)
            {
                ...
                int index14 = checked(index12 + 1);
                this.HDA[index14, 0] = "";
                this.HDA[index14, 1] = "Presentation";
                this.HDA[index14, 2] = Conversions.ToString(Program.OpenDB[Program.PcIndex].PCFactorsSeg1[2]);
            ...
            else if (Operators.CompareString(seg, "0F", false) == 0)
            {
                ...
                int index28 = checked(index26 + 1);
                this.HDA[index28, 0] = "";
                this.HDA[index28, 1] = "Presentation";
                this.HDA[index28, 2] = Conversions.ToString(Program.OpenDB[Program.PcIndex].PCFactorsSeg2[2]);
                ...
                index1 = index28; //checked(index29 + 1);
                //this.HDA[index1, 0] = "";
                //this.HDA[index1, 1] = "";
            ...
            else if (Operators.CompareString(seg, "SF", false) == 0)
            {
                ...
                int index43 = checked(index41 + 1);
                this.HDA[index43, 0] = "";
                this.HDA[index43, 1] = "Presentation";
                this.HDA[index43, 2] = Conversions.ToString(Program.OpenDB[Program.PcIndex].PCFactorsSeg1[2]);
                ...
                int index52 = checked(index50 + 1);
                this.HDA[index52, 0] = "";
                this.HDA[index52, 1] = "Presentation";
                this.HDA[index52, 2] = Conversions.ToString(Program.OpenDB[Program.PcIndex].PCFactorsSeg2[2]);
            ...
            else if (Operators.CompareString(seg, "FF", false) == 0)
            {
                ...
                int index67 = checked(index65 + 1);
                this.HDA[index67, 0] = "";
                this.HDA[index67, 1] = "Presentation";
                this.HDA[index67, 2] = Conversions.ToString(Program.OpenDB[Program.PcIndex].PCFactorsSeg1[2]);
                ...
                int index76 = checked(index74 + 1);
                this.HDA[index76, 0] = "";
                this.HDA[index76, 1] = "Presentation";
                this.HDA[index76, 2] = Conversions.ToString(Program.OpenDB[Program.PcIndex].PCFactorsSeg2[2]);
            ...
            else if (Operators.CompareString(seg, "SS", false) == 0)
            {
                ...
                int index91 = checked(index89 + 1);
                this.HDA[index91, 0] = "";
                this.HDA[index91, 1] = "Presentation";
                this.HDA[index91, 2] = Conversions.ToString(Program.OpenDB[Program.PcIndex].PCFactorsSeg1[2]);
                ...
                int index100 = checked(index98 + 1);
                this.HDA[index100, 0] = "";
                this.HDA[index100, 1] = "Presentation";
                this.HDA[index100, 2] = Conversions.ToString(Program.OpenDB[Program.PcIndex].PCFactorsSeg2[2]);
