...
namespace ClubCompFS
{
    ...
    public class HeadPageDialog : Form
    {
        ...
        (ToolStripItem) this.HeadPageToolStripMenuItem
            ...
            this.Label8.Text = "Skating Skills"; // "Impostazione di base";
            ...
            this.Label10.Text = "Performance/Execution"; // "Performance";
            ...
            this.lbl25.Text = "Performance/Execution";
        ...
        private void ExportHeadPageToPDF(int norow, int nocol, string txt, string pathfile, int msg)
        {
            ...
            if (num1 == 2)
            {
                int num10 = (int)Interaction.MsgBox((object)("ResultsForm, ExportDataToPDFTable1 - \r\n" + Information.Err().Description), MsgBoxStyle.Critical, (object)"Susanne SW");
            }
            label_24:
            if (num2 == 0)
                return;
