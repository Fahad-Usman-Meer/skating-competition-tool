...
namespace ClubCompFS
{
  ...
  public class Form7 : Form
  {
    ...
    internal virtual DataGridView DataGridView1
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._DataGridView1 = value;
    }
    ...
    {
      get => this._txtPar;
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._txtPar = value;
    }

    internal virtual TextBox txtPartNo
    {
      get => this._txtPartNo;
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._txtPartNo = value;
    }
...
label_65:
    ...
    {
      this.Text = "WARMUP GROUPS: " + Microsoft.VisualBasic.Strings.UCase(Module1.Category.Name) + Module1.SubCat() + ", " + Module1.GetSegTxt(Module1.Segment);
      DataGridView dataGridView1 = this.DataGridView1;
...
label_15:
    ...
    private void PrintDocument1_PrintPage_1(object sender, PrintPageEventArgs e)
    {
      ...
      try
      {
        ...
        float y5 = y4 + 20f;
        e.Graphics.DrawString("Ice Emotion | Created: " + Module1.DateTimeToStr(DateTime.Now), font4, Brushes.Black, (float) pageLeftMargin, y5, new StringFormat());
        goto label_29;
      }
      catch (Exception ex) when (ex != null & num1 != 0 & num2 == 0)
      {
...
label_24:
    ...
    private void ExportDataToPDFTable1(string pathfile, int msg)
    {
      ...
      try
      {
        ...
        xgraphics1.DrawLine(XPens.Gray, num4, checked (num8 - 1), checked (num4 + width1), checked (num8 - 1));
        DataGridView dataGridView1 = this.DataGridView1;
        int index = 0;
        while (index < dataGridView1.RowCount)
        {
          ...
          foreach (DataGridViewCell cell in (BaseCollection) row.Cells)
          {
            ...
            switch (cell.ColumnIndex)
            {
              case 0:
                if (index == 0)
                  xgraphics1.DrawLine(XPens.Gray, num9, checked (num8 - 1), num9, checked (num8 + height3 + 1));
                XGraphics xgraphics3 = xgraphics1;
                string str4 = str3;
                XFont xfont7 = xfont6;
                XSolidBrush black2 = XBrushes.Black;
                XRect xrect2 = new XRect((double) checked (num9 + 1), (double) num8, (double) width2, (double) height3);
              ...
              case 1:
                ...
                XRect xrect3 = new XRect((double) checked (num9 + 1), (double) num8, (double) width2, (double) height3);
              ...
              case 2:
                ...
                XRect xrect4 = new XRect((double) checked (num9 + 1), (double) num8, (double) width2, (double) height3);
              ...
              case 3:
                ...
                XRect xrect5 = new XRect((double) checked (num9 + 1), (double) num8, (double) width2, (double) height3);
              ...
              case 4:
                ...
                XRect xrect6 = new XRect((double) checked (num9 + 1), (double) num8, (double) width2, (double) height3);
              ...
              case 5:
                ...
                XRect xrect7 = new XRect((double) checked (num9 + 1), (double) num8, (double) width2, (double) height3);
              ...
              case 6:
                ...
                XRect xrect8 = new XRect((double) checked (num9 + 1), (double) num8, (double) width2, (double) height3);
                ...
                if (index == 0)
                {
                  xgraphics1.DrawLine(XPens.Gray, checked (num9 + width2), checked (num8 - 1), checked (num9 + width2), checked (num8 + height3 + 1));
                  break;
                }
                break;
            }
          ...
          if (index == 0)
          {
            checked { num8 += height3 + 1; }
            xgraphics1.DrawLine(XPens.Gray, num4, num8, checked (num4 + width1), num8);
          }
          else
            checked { num8 += height3; }
          checked { ++index; }
        }
        int y5 = checked (num8 + height3);
        XGraphics xgraphics10 = xgraphics1;
        string str11 = "Ice Emotion | Created: " + Module1.DateTimeToStr(DateTime.Now);
