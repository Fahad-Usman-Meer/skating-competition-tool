...
namespace ClubCompFS
{
  ...
  public class Form12 : Form
  {
    ...
    internal virtual TextBox txtNoOfParticipants
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._txtNoOfParticipants = value;
    }
    ...
    internal virtual ToolStripMenuItem SORTERAToolStripMenuItem
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._SORTERAToolStripMenuItem = value;
    }
    ...
    internal virtual TextBox txtNoIndTA
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._txtNoIndTA = value;
    }
    ...
    internal virtual DataGridViewTextBoxColumn IndTADiscipline
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._IndTADiscipline = value;
    }
    ...
    internal virtual TextBox txtSelected
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._txtSelected = value;
    }

    internal virtual TextBox txtIndTAGet
    {
      get => this._txtIndTAGet;
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._txtIndTAGet = value;
    }
